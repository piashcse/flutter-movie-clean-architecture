...
class _UpcomingTvSeriesPageState extends ConsumerState<UpcomingTvSeriesPage> {
  ...
  Future<void> _loadPage(int page) async {
    ...
    final result = await ref.read(upcomingTvSeriesProvider(page).future);

    setState(() {
      if (result.isNotEmpty) {
        _tvSeries.addAll(result);
      } else {
        _hasMore = false;
      }
